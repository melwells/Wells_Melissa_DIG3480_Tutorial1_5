...
public class PlayerController : MonoBehaviour
{
  ...
  void Start()
   ...
   // The code below here sets the Integer value of our anim variable based on whether we have the W key pressed down or not.
   //If it is pressed down, the State integer gets set to 1; when it is released, we set it back to 0.
